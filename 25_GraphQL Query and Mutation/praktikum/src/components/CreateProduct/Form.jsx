...
const Form = ({ lang, edit, id }) => {
  ...
  // console.log(data.store_product);
    ...
    <form
      ...
      onSubmit={(e) => {
        ...
        if (edit) {
          ...
          updateProduct({
            variables: {
              additional_information: descInput.current?.value,
              price: priceInput.current?.value,
              product_category: categoryInput.current.value,
              product_freshness: freshnessInput,
              product_name: nameInput.current?.value,
              id: id,
            },
          });
          return;
